<template>
  <div class="flex flex-col items-center m-auto mt-20">
    <h1 class="text-5xl font-semibold">Upcoming Anime</h1>
    <div class="grid grid-cols-4 grid-rows-2 gap-5 mt-10">
      <!-- 2 Rows of trending-->
      <AnimeCard v-for="anime in upcoming" :key="anime.mal_id" :anime="anime">
...
(async () => {
  ...
  upcoming.value = response.data.splice(0, 8);
})();
</script>
